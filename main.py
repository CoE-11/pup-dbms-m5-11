...
class RegisterPage(webapp2.RequestHandler):
    ...
    def post(self):
        ...
        if faculty_email or email == 'gino.tr14@gmail.com' or email == 'nolascoarian@gmail.com' or email == 'wamvill@gmail.com':
            authority = 'faculty'
        else:
            authority = 'reader'
    ...
    def get(self,th_id):
        ...
        if authority == 'faculty':
            ...
            for studs in d.thesis_student_keys:
                ...
                s.key.delete()
            d.key.delete()
            self.response.write("Thesis Deleted go back <a href='/'>home</a>")
        else:
            self.response.write("<script>alert('For faculty users only...');</script>")
            self.response.write("Go back <a href='/'>home</a>.")
...
class  DeleteStudent(webapp2.RequestHandler):
    def get(self,s_id):
        ...
        if authority == 'faculty':
            ...
            s = key_to_delete.get()
            s.key.delete()
            self.response.write("Student Deleted go back <a href='/'>home</a>")
        else:
            self.response.write("<script>alert('For faculty users only...');</script>")
            self.response.write("Go back <a href='/'>home</a>.")
...
class  DeleteFaculty(webapp2.RequestHandler):
    def get(self,f_id):
        ...
        if authority == 'faculty':
            ...
            f = key_to_delete.get()
            f.key.delete()
            self.response.write("Faculty Deleted go back <a href='/'>home</a>")
        else:
            self.response.write("<script>alert('For faculty users only...');</script>")
            self.response.write("Go back <a href='/'>home</a>.")
    ...
    def get(self,c_id):
        ...
        if authority == 'faculty':
            ...
            if d:
                ...
                d.put()
            c.key.delete()
            self.response.write("College Deleted go back <a href='/'>home</a>")
        else:
            self.response.write("<script>alert('For faculty users only...');</script>")
            self.response.write("Go back <a href='/'>home</a>.")
...
class  DeleteUniversity(webapp2.RequestHandler):
    def get(self,u_id):
        ...
        if authority == 'faculty':
            ...
            self.response.write("University Deleted go back <a href='/'>home</a>")
        else:
            self.response.write("<script>alert('For faculty users only...');</script>")
            self.response.write("Go back <a href='/'>home</a>.")
            ...
            if authority == 'faculty':
                ...
                if adv is None:
                    adv = Faculty(key=ndb.Key(Faculty, adviser_keyname), f_first_name=adv_fname, f_last_name=adv_lname, f_middle_name=adv_midname,\
                        ...
                        f_picture=obj['pic_path'],f_title=obj['faculty_data']['f_title'])
                    adv.put()
                ...
                if s:
                    for student in s:
                        if student.s_first_name == first_name and student.s_middle_name == middle_name:
                            ...
                            for i in range(len(obj['thesis'])):
                                t = Thesis.query(Thesis.thesis_title == obj['thesis'][i]).get()
                                if len(t.thesis_student_keys) < 5:
                                    stud.put()
                                    t.thesis_student_keys.append(stud.key)
                                    t.put()
                                    self.response.headers['Content-Type'] = 'application/json'
                                    response = {
                                        'status':'OK',
                    ...
                    for i in range(0,len(obj['thesis'])):
                        t = Thesis.query(Thesis.thesis_title == obj['thesis'][i]).get()
                        if len(t.thesis_student_keys) < 5:
                            stud.put()
                            t.thesis_student_keys.append(stud.key)
